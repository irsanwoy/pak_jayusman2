        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="flex items-center space-x-4 mb-4">
                    ...
                    <form method="GET" action="{{ route('transactionDetail.index') }}" class="flex items-center space-x-2">
                    ...
                    <form action="{{ route('transactionDetail.index') }}" method="GET" class="flex items-center space-x-2">
                    ...
                    <a href="{{ route('transactionDetail.printByBranchForm') }}" class="bg-orange-500 text-white px-4 py-2 rounded-md hover:bg-orange-600 mb-4 inline-block">Print By Branch</a>
